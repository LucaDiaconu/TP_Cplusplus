...
Mammal::Mammal(string _name, string _color, string _furColor, string _diet, string _habitat, string _sounds, bool _isPet, int _age, double _weight, double _height)
        : Animal("Mammal", _name, _color, _diet, _habitat, _sounds, isPet, _age, _weight, _height), furColor(_furColor)
        {

}

Mammal::Mammal(const Mammal &mammal)
        : Animal(mammal.type, mammal.name, mammal.color, mammal.diet, mammal.habitat, mammal.sounds, mammal.isPet, mammal.age,
